...
全て独学で開発しました。
スピード感を意識して、約1ヶ月半でMusclenutriを作成致しました。
...
## このアプリを開発した背景
私は小学校１年生から大学3回生の6月までの15年間、部活で野球をしていました。野球をしていたときに体作りにとても悩んだ時があり、そこでプロテインやサプリを利用し活用することによって、体作りがうまくいくようになったのでプロテインやサプリの大切さを知りそこで主に競技スポーツをしている人にプロテインやサプリのミスマッチがないようにするために作成しました。
